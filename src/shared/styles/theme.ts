...
const lightColors = {
  ...
  borderSubtle: '#E0E5EB',
  borderStrong: '#A8B0BA',
  borderMuted: '#00000018',
  accent: '#3182F6',
  accentSeg: '#FFFFFF',
  accentSegText: '#14181F',
  up: '#E42939',
  down: '#2272EB',
  flat: '#6B7684',
  cardBg: '#FFFFFF',
  ...
  popoverBg: '#FFFFFF',
  popoverText: '#14181F',
  popoverShadow: '0 12px 32px rgba(15,23,42,0.16), 0 4px 12px rgba(15,23,42,0.08)',
...
const darkColors = {
  ...
  popoverBg: '#1C2027',
  popoverText: '#F2F4F6',
  popoverShadow: '0 12px 32px rgba(0,0,0,0.5), 0 4px 8px rgba(0,0,0,0.3)',
  // Tinted
  accentTint: '#4593FC15',
